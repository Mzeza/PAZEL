...
const defaultData={
 ...
 notes:[], goals:{year:[],month:[],week:[]}, habits:[
  {id:1,name:"ورزش صبحگاهی",done:{}},{id:2,name:"مطالعه کتاب",done:{}},{id:3,name:"نوشیدن آب کافی",done:{}},{id:4,name:"مدیتیشن",done:{}}
 ], events:{}
};
...
document.getElementById("menuBtn").onclick=()=>toast("اطلاعات شما به صورت خودکار ذخیره می‌شود");
function calendar(){
